...
**[ReviewQR AI](https://ai-powered-google-review.vercel.app/)** — an AI-powered SaaS platform I designed and built end-to-end (frontend, backend, infra) that helps local businesses grow Google reviews through QR-based smart feedback flows, with Gemini-powered multilingual, sentiment-aware review generation.
...
|---|---|---|
| **[ReviewQR AI](https://ai-powered-google-review.vercel.app/)** | AI-powered review automation SaaS with multilingual, sentiment-aware generation | Next.js, TypeScript, Node.js, MongoDB, Gemini API |
